...
class TestAddAddress(unittest.TestCase):
    ...
    def test_add_address(self):
        ...
        self.add_address_contact(wd, Contact("test", "test", "test", "test", "test", "test",
    ...
    def test_add_address_empty(self):
        ...
        self.open_main_page(wd)
        self.login(wd, "admin", "secret")
        self.add_address_contact(wd, Contact("", "", "", "", "", "",
                                                 "", "", "", "", "", "",
                                                 "", "", "", "", "", ""),
                                     Date("", "-", ""), Date("", "-", ""))
        self.logout(wd)
    ...
    def add_address_contact(self, wd, contact, date, date2):
        self.init_contact_creation(wd)
        self.fill_primary_data_inputs(wd, contact, date, date2)
        self.submit_contact(wd)

    def submit_contact(self, wd):
        wd.find_element_by_xpath("(//input[@name='submit'])[2]").click()

    def fill_primary_data_inputs(self, wd, contact, date, date2):
        ...
        # add dates
        self.pick_b_date(wd, date)
        self.pick_a_date(wd, date2)
